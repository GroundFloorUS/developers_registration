...
module CmsPagesAuth
  def authenticate
    logger.debug("CmsPagesAuth  Authentication: #{@cms_page.layout.identifier}")
    if @cms_page.layout.identifier == "protected"
      logger.debug("Protected Page: #{current_user}")
...
ComfortableMexicanSofa::HttpAuth.password = 'b1gm0n3y'
...
ComfortableMexicanSofa::ViewHooks.add(:navigation, '/layouts/admin/navigation_extensions')