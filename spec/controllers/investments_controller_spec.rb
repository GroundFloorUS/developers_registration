  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved investment as @investment" do
        ...
        post :create, {:investment => { "user_id" => "invalid value" }}, valid_session
        assigns(:investment).should be_a_new(Investment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested investment" do
        ...
        Investment.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => investment.to_param, :investment => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the investment as @investment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Investment.any_instance.stub(:save).and_return(false)
        put :update, {:id => investment.to_param, :investment => { "user_id" => "invalid value" }}, valid_session
        assigns(:investment).should eq(investment)
      end
